...
# To run this script, you need to use the following command:
# spark-submit movie-recommendations-als-dataframe.py 0
# If you get numpy errors, you may need to install numpy on your computer.
# pip3 install numpy
...
ratings = spark.read.option("sep", "\t").schema(moviesSchema) \
    .csv("file:///Users/rwuniard/projects/udemy_spark/ml-100k/u.data")
